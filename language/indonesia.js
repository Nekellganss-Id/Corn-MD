...
exports.menunya = (salam, pushname) =>{
	return`Hai idoll ${pushname} 👋 selamat ${salam} , 
saya Cornfakebot-Md, bot ini adalah Beta Multi-Device Whatsapp. 
...
⚠️ Segala kebijakan dan ketentuan CornFake di pegang oleh owner dan segala perubahan kebijakan, sewaktu waktu owner berhak mencabut, memblokir user(*﹏*) 

Arigatou Gozaimasu! Untuk kalian user ramah dan Beberapa orang yg ikut membantu juga dalam project pembuatan CornFake
😖🙏
`
}
exports.welcome = () =>{
	return`𝖩𝖺𝗇𝗀𝖺𝗇 𝗅𝗎𝗉𝖺 𝗂𝗇𝗍𝗋𝗈 dulu ya sayang 🤗
...
exports.leave = () =>{
	return`Yah beban out 😣 Mental aman ? >.<
Goodbye Beban`
}
exports.source = () =>{
return`*── 「 SOURCE 」 ──*

Kaga Dulu Deh Bro Gw Aja Susah Hehe
`
}
